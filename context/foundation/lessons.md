...
- **Rule**: After making new changes that result in updates to @context/foundation/changes, GitHub issues should be
  updated accordingly (created, commented or closed).
