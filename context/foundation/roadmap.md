...
- **S-06: new users have 3 default templates and a set of default option groups seeded into their personal data on first login.** — Archived 2026-06-05 → `context/archive/2026-06-05-onboarding-defaults/`. Lesson: —.
